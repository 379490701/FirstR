...
public class Transform extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {//v表示一个点击动作发生
            ...
            case R.id.button_equal:
                ...
                text.setText("二进制：" + Integer.toBinaryString(temp) + "\n" +
                        "八进制：" + Integer.toOctalString(temp) + "\n" +
                        "十六进制：" + Integer.toHexString(temp));
                break;
        }
    }
}
